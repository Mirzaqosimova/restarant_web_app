...
const Validators = require('../../validation/index')
 ...
 function validation(validator) {
    ...
    return async function(req, res, next) {
        ...
        Object.entries(req.body).length !== 0? validationObject['body'] = req.body: '';
        Object.entries(req.params).length !== 0? validationObject['params'] = req.params: '';
        Object.entries(req.query).length !== 0? validationObject['query'] = req.param: '';
